...
public class RightPane extends BorderPane {
        ...
        addButton.setOnAction(event -> {
            ...
            if (!newTag.isEmpty()) {
                if (!Database.getTagDatabase().contains(newTag)) {
                    ...
                    if (SharedFrontend.getLeftPane().getDisplayMode() == LeftPaneDisplayMode.TAGS)
                        SharedFrontend.getLeftPane().refreshContent();
                }
                ...
                SharedFrontend.getRightPane().refreshContent();
            }
        });
    ...
    private void refreshContent() {
        SharedFrontend.getRightPane().getListView().getItems().setAll(Database.getSelectedItemsSharedTags());
    }
