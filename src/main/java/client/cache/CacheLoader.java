...
public abstract class CacheLoader {
	...
	public static void init(EntityList entityList) {
		init(entityList, false);
	}
	public static void init(EntityList entityList, boolean recreate) {
	...
	public static void reset() {
		...
		CacheLoader.init(Root.ENTITYLIST, true);
	}
