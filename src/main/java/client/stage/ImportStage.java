...
import client.node.CheckboxNode;
import client.node.EditNode;
import client.node.SwitchNode;
...
public class ImportStage extends AbstractStageBase {
	...
	private void setupFilter() {
		//todo	Root.FILTER.getFilterSettingsManager().setShowImages(true);
		//		Root.FILTER.getFilterSettingsManager().setShowGifs(true);
		//		Root.FILTER.getFilterSettingsManager().setShowVideos(true);
		//		Root.FILTER.getFilterSettingsManager().setOnlySession(true);
		//		Root.FILTER.getFilterSettingsManager().setEnableLimit(false);
	}
