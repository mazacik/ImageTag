	...
	public ColorModeSwitchNode() {
		node1.addEventFilter(MouseEvent.MOUSE_CLICKED, MouseButton.PRIMARY, () -> {
			if (ColorUtil.isNightMode()) {
				...
				node1.setGraphic(new ImageView("application/gui/resources/icon-sun-1.png"));
				node2.setGraphic(new ImageView("application/gui/resources/icon-moon-1.png"));
		...
		node2.addEventFilter(MouseEvent.MOUSE_CLICKED, MouseButton.PRIMARY, () -> {
			if (!ColorUtil.isNightMode()) {
				...
				node1.setGraphic(new ImageView("application/gui/resources/icon-sun-2.png"));
				node2.setGraphic(new ImageView("application/gui/resources/icon-moon-2.png"));
