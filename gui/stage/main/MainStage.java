...
import application.gui.component.switchnode.SwitchNodeColorMode;
...
import application.gui.main.center.MediaPaneControls;
...
public class MainStage extends StageBase implements InstanceCollector {
	...
	private void initIntroScene() {
		...
		vBoxStartMenu.getChildren().add(new ImageView(new Image("application/gui/resource/logo-1.png")));
