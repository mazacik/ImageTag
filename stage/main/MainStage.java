package application.stage.main;

import application.base.CustomList;
import application.base.Project;
import application.component.custom.ColorModeSwitchNode;
import application.component.custom.RecentProjectNode;
import application.component.simple.EditNode;
...
import application.pane.center.MediaPaneControls;
...
import application.util.enums.SystemUtil;
...
public class MainStage extends StageBase implements InstanceCollector {
	...
	private void initIntroScene() {
		...
		vBoxStartMenu.getChildren().add(new ImageView(new Image("application/resource/logo-1.png")));
