    ...
    public VideoPlayer(Canvas canvas) {
        ...
        mediaPlayer.events().addMediaPlayerEventListener(new MediaPlayerEventAdapter() {
            ...
            public void positionChanged(MediaPlayer mediaPlayer, float newPosition) {
                ...
                InstanceRepo.mediaView.getControls().setVideoProgress(newPosition);
            }
        });
        mediaPlayer.events().addMediaPlayerEventListener(new MediaPlayerEventAdapter() {
            @Override
            public void timeChanged(MediaPlayer mediaPlayer, long newTime) {
                ...
                InstanceRepo.mediaView.getControls().setTimeCurrent(newTime);
            }
        });
        mediaPlayer.events().addMediaPlayerEventListener(new MediaPlayerEventAdapter() {
            @Override
            public void lengthChanged(MediaPlayer mediaPlayer, long newLength) {
                ...
                InstanceRepo.mediaView.getControls().setTimeTotal(newLength);
            }
        });
        ...
        mediaPlayer.events().addMediaPlayerEventListener(new MediaPlayerEventAdapter() {
            ...
            public void opening(MediaPlayer mediaPlayer) {
                ...
                InstanceRepo.mediaView.getControls().setVideoProgress(0);
            }
        });
        mediaPlayer.events().addMediaPlayerEventListener(new MediaPlayerEventAdapter() {
            @Override
            public void finished(MediaPlayer mediaPlayer) {
                ...
                InstanceRepo.mediaView.getControls().setVideoProgress(1);
            }
        });
    }
